...
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojselectcombobox', 'ojs/ojbutton'],
  function(oj, ko, $) {
    ...
    function ViewModel() {
      ...
      self.flag1 = ko.observable(false);
      self.flag2 = ko.observable('');
      self.finalFlag = ko.pureComputed(function () {
        return (self.flag1() === '' || self.flag1() === '') ? false : (self.flag1() === self.flag2());
      });
      // self.finalFlag = ko.observable(false);
      // setTimeout(function() {
      //   self.flag1(false);
      // }, 3000);
    }
